...
//  SPI_I2S_ITConfig(MRFI_SPI, SPI_I2S_IT_RXNE, ENABLE);
//  
//  NVIC_InitStructure.NVIC_IRQChannel = MRFI_SPI_IRQn;
...
//void MRFI_SPI_IRQHandler(void)
//{
//  if(SPI_I2S_GetFlagStatus(MRFI_SPI, SPI_I2S_FLAG_RXNE) != RESET)
//  {
//    SPI_I2S_ClearFlag(MRFI_SPI, SPI_I2S_FLAG_RXNE);
//    
//  }
//  
//  if(SPI_I2S_GetFlagStatus(MRFI_SPI, SPI_I2S_FLAG_TXE) != RESET)
//  {
//    SPI_I2S_ClearFlag(MRFI_SPI, SPI_I2S_FLAG_TXE);
//    
//  }
//}
