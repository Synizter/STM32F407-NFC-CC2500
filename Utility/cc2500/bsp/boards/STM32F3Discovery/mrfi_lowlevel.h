...
#define MRFI_GDO0_GPIO_PORT                GPIOC
#define MRFI_GDO0_GPIO_CLK                 RCC_AHBPeriph_GPIOC
...
#define MRFI_GDO0_EXTI_PORT_SOURCE         EXTI_PortSourceGPIOC
#define MRFI_GDO0_EXTI_IRQn                EXTI0_IRQn
#define MRFI_GDO0_EXTI_IRQHandler          EXTI0_IRQHandler
