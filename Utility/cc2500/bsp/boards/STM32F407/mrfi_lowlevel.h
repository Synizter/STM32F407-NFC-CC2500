 ...
 */
#define MRFI_GDO0_PIN                      GPIO_Pin_14
...
#define MRFI_GDO0_EXTI_LINE                EXTI_Line14
#define MRFI_GDO0_EXTI_PIN_SOURCE          EXTI_PinSource14
 ...
 * CS Pin macro.
 */
#define MRFI_SPI_DRIVE_CSN_HIGH()             GPIO_SetBits(MRFI_CS_GPIO_PORT, MRFI_CS_PIN)
#define MRFI_SPI_DRIVE_CSN_LOW()              GPIO_ResetBits(MRFI_CS_GPIO_PORT, MRFI_CS_PIN)
#define MRFI_SPI_CSN_IS_HIGH()                GPIO_ReadOutputDataBit(MRFI_CS_GPIO_PORT, MRFI_CS_PIN)
