...
static void (*Mrfi_ControlRxModeOff)(void);
static void (*Mrfi_ControlRxModeOn)(void);

/**************************************************************************************************
 * @fn          MRFI_SetRxModeControl
 * @brief       Set logical channel.
 * @param       RxCtrlOff - pointer to function for change rx mode to off.
 * @param       RxCtrlOn - pointer to function for change rx mode to on.
 * @return      none
 **************************************************************************************************
 */
void MRFI_SetRxModeControl(void (*RxCtrlOff)(void), void (*RxCtrlOn)(void))
{
  Mrfi_ControlRxModeOff = RxCtrlOff;
  Mrfi_ControlRxModeOn = RxCtrlOn;
}
